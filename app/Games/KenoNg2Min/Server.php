                ...
                \DB::transaction(function() use ($request, $game)
                {
                    ...
                    switch( $aid )
                    {
                        case 'init':
                            ...
                            $slotSettings->SetGameData('KenoNg2MinCurrentDenom', $slotSettings->CurrentDenom);
                            $balanceInCents = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                        ...
                        case 'get':
                            ...
                            $winstring = '';
                            $slotSettings->SetGameData('KenoNg2MinTotalWin', $totalWin);
                            $slotSettings->SetGameData('KenoNg2MinGambleStep', 5);
                            $hist = $slotSettings->GetGameData('KenoNg2MinCards');
                            $numStr = [];
